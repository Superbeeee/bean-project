  ...
  <div class="flex min-h-screen items-center justify-center px-4 pt-[120px] pb-10">
    <div class="w-full max-w-md">
      ...
      <div class="mb-6 flex items-center gap-3">
        ...
        <span class="text-xs text-gray-400">或使用電子郵件</span>
        <div class="h-px flex-1 bg-gray-200"></div>
      </div>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-4">
        ...
        <div>
          <label class="mb-1 block text-sm text-gray-600">電子郵件</label>
          <input
            v-model="form.email"
            type="email"
            required
        ...
        <div>
          <label class="mb-1 block text-sm text-gray-600">密碼</label>
          <input
